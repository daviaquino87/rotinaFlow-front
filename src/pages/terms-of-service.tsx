      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-600 leading-relaxed">
          <section>
            ...
            <p>
              Ao acessar ou usar o <strong>rotinaFlow</strong>, você concorda com estes Termos de
              Serviço. Se você não concordar com algum dos termos, não utilize o serviço. O uso do
              rotinaFlow implica aceitação integral destas condições.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              O rotinaFlow é uma plataforma de organização de rotina semanal que utiliza
              inteligência artificial para criar rotinas personalizadas e sincronizá-las com o
              Google Calendar. O serviço oferece:
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>
                Criação de rotinas personalizadas por IA com base nas suas preferências e objetivos.
              </li>
              <li>Sincronização automática de eventos com o Google Calendar.</li>
              <li>
                Um modelo de créditos para utilização do serviço após a primeira rotina gratuita.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Você é responsável pela segurança da sua conta Google e por todas as atividades
                realizadas com ela.
              </li>
              <li>Você deve ter pelo menos 13 anos de idade para usar o serviço.</li>
              <li>
                É proibido criar contas falsas, usar o serviço de forma automatizada sem autorização
                ou compartilhar seu acesso com terceiros.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Pagamentos são processados pelo Stripe e não são reembolsáveis, exceto em casos de
                erro técnico comprovado do serviço.
              </li>
              <li>
                Em caso de problema com um pagamento, entre em contato em até 7 dias úteis após a
                transação.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Ao autorizar o acesso ao Google Calendar, você permite que o rotinaFlow crie, edite e
              exclua eventos em seu calendário conforme sua aprovação explícita dentro do app. Você
              pode revogar esse acesso a qualquer momento nas configurações da sua conta Google.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Realizar engenharia reversa, modificar ou distribuir o software sem autorização.
              </li>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-800 mb-2">
              7. Disponibilidade e qualidade
            </h2>
            <p>
              Nos esforçamos para manter o serviço disponível continuamente, mas não garantimos
              disponibilidade ininterrupta. Podemos suspender o serviço para manutenção com ou sem
              aviso prévio. A qualidade das rotinas geradas por IA pode variar — o serviço não
              substitui orientação profissional de saúde, nutrição ou carreira.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Todo o conteúdo, design e código do rotinaFlow são de propriedade do serviço e
              protegidos por direitos autorais. As rotinas geradas para você são de seu uso pessoal.
              Você mantém a propriedade do conteúdo que fornece para gerar suas rotinas.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              O rotinaFlow é fornecido "como está". Não nos responsabilizamos por danos indiretos,
              incidentais ou consequentes decorrentes do uso ou impossibilidade de uso do serviço.
              Nossa responsabilidade total fica limitada ao valor pago pelos créditos nos últimos 30
              dias.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Podemos suspender ou encerrar sua conta caso você viole estes termos. Você pode
              encerrar sua conta a qualquer momento solicitando a exclusão dos seus dados pelo
              e-mail de contato. Créditos não utilizados não são reembolsáveis em caso de
              encerramento por violação dos termos.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Podemos atualizar estes termos periodicamente. Notificaremos você por e-mail ou aviso
              no serviço sobre mudanças relevantes. O uso continuado após as alterações implica
          ...
          <section>
            ...
            <p>
              ...
              disputas serão resolvidas no foro da comarca de domicílio do usuário, conforme o
